...
\section{Education}
  \CVSubHeadingListStart
    \CVSubheading
      ...
      \CVItemListStart
        \CVItem{Focus: Distributed Systems, Mobile Systems, Complex Event Processing, Machine Learning.}
        \CVItem{Thesis: ``Enhancing RSSI-based Positioning Accuracy using Advanced Filtering Techniques''.}
      \CVItemListEnd
    \CVSubheading
